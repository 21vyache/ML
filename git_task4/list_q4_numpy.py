...
def word_count(word_list):
    ...
    word, count = np.unique(word_list, return_counts=True)
    w_count = dict(zip(word, count))
    return w_count


word_list = np.array(['Python', 'consistently', 'ranks', 'as', 'one', 'of', 'the', 'most', 'popular', 'programming', 'languages'])
